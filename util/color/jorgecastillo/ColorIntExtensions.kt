...
// */
//
//fun rgbColorInt(red: Float, green: Float, blue: Float): ColorInt {
//    return -0x1000000 or
...
// */
//
//fun hslToColor(hsl: FloatArray): ColorInt {
//    val h = hsl[0]
//    val s = hsl[1]
//    val l = hsl[2]
//
...
// */
////fun ColorInt.isDark(): Boolean = ColorUtils.calculateLuminance(this) < 0.5
//
///**
...
// */
////fun ColorInt.contrasting(
////    lightColor: ColorInt = Color.White.toArgb(),
////    darkColor: ColorInt = Color.Black.toArgb()
////) = if (isDark()) {
////    lightColor
////} else {
////    darkColor
...
// */
//
//fun ColorInt.lighten(value: Float): ColorInt {
...
// */
//
//fun ColorInt.lighten(value: Int): ColorInt {
//    val hsla = this.asHsla()
//    var lightness = hsla.lightness
...
// */
//
//fun ColorInt.darken(value: Float): ColorInt {
//    val hsla = this.asHsla()
//    var lightness = hsla.lightness
//    lightness -= value
//    lightness = 0f.coerceAtLeast(lightness.coerceAtMost(1f))
...
// */
//
//fun ColorInt.darken(value: Int): ColorInt {
//    val hsla = this.asHsla()
//    var lightness = hsla.lightness
//    lightness -= value / 100f
//    lightness = 0f.coerceAtLeast(lightness.coerceAtMost(1f))
...
// */
//fun ColorInt.shades(count: Int = 10): List<ColorInt> {
...
// */
//fun ColorInt.tints(count: Int = 10): List<ColorInt> {
//    require(count > 0) { "count must be > 0" }
//    val hsla = this.asHsla()
//
//    val start = (hsla.lightness * 10000000).roundToInt()
...
// */
//fun ColorInt.complimentary(): ColorInt {
...
// */
//fun ColorInt.triadic(): Pair<ColorInt, ColorInt> {
//    val colorHSLA = this.asHsla()
//    val hue = colorHSLA.hue // 0° to 359°
//
...
// */
//fun ColorInt.tetradic(): Triple<ColorInt, ColorInt, ColorInt> {
//    val colorHSLA = this.asHsla()
//    val hue = colorHSLA.hue // 0° to 359°
//
...
// */
//fun ColorInt.analogous(): Pair<ColorInt, ColorInt> {
//    val colorHSLA = this.asHsla()
//    val hue = colorHSLA.hue // 0° to 359°
//
