...
//     */
//
//    public static int LABToColor( final double l,
//                                  final double a,
//                                  final double b) {
//        final double[] result = getTempDouble3Array();
...
//     */
//    @SuppressWarnings("unused")
//    public static void blendHSL( float[] hsl1,  float[] hsl2,
//                                 float ratio,  float[] outResult) {
...
//     */
//    @SuppressWarnings("unused")
//    public static void blendLAB( double[] lab1,  double[] lab2,
//                                 double ratio,  double[] outResult) {
//        if (outResult.length != 3) {
...
//     * @see <a href="https://developer.android.com/design/ui/mobile/guides/styles/color#about-color-spaces">About Color Spaces</a>
//     */
//    @SuppressWarnings("AcronymName")
//
//    public static int M3HCTToColor( float hue,
//
//                                   float chroma,  float tone) {
